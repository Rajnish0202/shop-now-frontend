...
export const GET_MONTLY_ORDER_INCOME_REQUEST =
  'GET_MONTLY_ORDER_INCOME_REQUEST';
export const GET_MONTLY_ORDER_INCOME_SUCCESS =
  'GET_MONTLY_ORDER_INCOME_SUCCESS';
export const GET_MONTLY_ORDER_INCOME_FAIL = 'GET_MONTLY_ORDER_INCOME_FAIL';

export const GET_YEARLY_ORDER_REQUEST = 'GET_YEARLY_ORDER_REQUEST';
export const GET_YEARLY_ORDER_SUCCESS = 'GET_YEARLY_ORDER_SUCCESS';
export const GET_YEARLY_ORDER_FAIL = 'GET_YEARLY_ORDER_FAIL';
