...
const OrderDetailsAdmin = () => {
  ...
  return (
    <>
      <MetaData
        title={`${adminOrder?.orderby?.firstname}'s Orders (${adminOrder?._id}`}
      />

      <div className='home-wrapper-2 p-1'>
        {loading ? (
          <Spinner />
        ) : (
            ...
            <div className='my-2 col-9 d-flex flex-column gap-30'>
              ...
              >
                <div className='d-flex align-items-center gap-10 mb-2'>
                  <h5 className='fw-bolder mb-0 fs-6'>Customer Name :</h5>
                  <p className='mb-0 fs-6'>
                    {adminOrder?.orderby?.firstname}{' '}
                    {adminOrder?.orderby?.lastname}
                  </p>
                </div>
                <div className='d-flex align-items-center gap-10 mb-2'>
                  <h5 className='fw-bolder mb-0 fs-6'>Order Id :</h5>
                  <p className='mb-0 fs-6'>{adminOrder?._id}</p>
                </div>
                <div className='mb-2'>
                  <h5 className='fw-bolder mb-0 fs-6'>Shipping Address :</h5>
                  <p className='mb-0 fs-6'>
                    {adminOrder?.shippingInfo?.street},&nbsp;
                    {adminOrder?.shippingInfo?.city},&nbsp;
                    {adminOrder?.shippingInfo?.state},&nbsp;
                    {adminOrder?.shippingInfo?.country} - &nbsp;
                    {adminOrder?.shippingInfo?.pinCode},
                  </p>
                </div>
                <div className='d-flex align-items-center gap-10 mb-2'>
                  <p className='fw-bold mb-0'>Email : </p>
                  <p className='mb-0'>{adminOrder?.orderby?.email}</p>
                </div>
                <div className='d-flex align-items-center gap-10 '>
                  <p className='fw-bold mb-0'>Mobile : </p>
                  <p className='mb-0'>{adminOrder?.shippingInfo?.phoneNo}</p>
                </div>
              </div>
              <div
                className='p-4'
              ...
              >
                <div className='d-flex align-items-center gap-10 mb-2'>
                  ...
                  >
                    {adminOrder?.paymentIntent?.method === 'Stripe'
                      ? 'Online Pay'
                      : adminOrder?.paymentIntent?.method}
                  </p>
                </div>
                <div className='d-flex align-items-center gap-10 mb-2'>
                  ...
                  <p
                    ...
                    style={{ fontWeight: '500' }}
                  >
                    {adminOrder?.paymentIntent?.paymentId}
                  </p>
                </div>
                <div className='d-flex align-items-center gap-10 mb-2'>
              ...
              >
                <h5 className='fw-bolder'>Customer Items</h5>
                ...
                <li>
                  <div>
                    ...
                    <div className='d-flex align-items-center justify-content-between my-2'>
                      ...
                      >
                        ₹{adminOrder?.cartTotal?.toFixed(2)}
                      </p>
                    </div>
                    <div className='d-flex align-items-center justify-content-between my-2'>
                      <p className='fw-bold mb-0'>After Discount:</p>
                      <p className='mb-0'>
                        ₹{adminOrder?.totalAfterDiscount?.toFixed(2)}
                      </p>
                    </div>
                    <div className='d-flex align-items-center justify-content-between my-2'>
                      <p className='fw-bold mb-0'>Tax:</p>
                      <p className='mb-0'>
                        ₹{adminOrder?.paymentIntent?.taxPrice?.toFixed(2)}
                      </p>
                    </div>
                    <div className='d-flex align-items-center justify-content-between my-2'>
                      <p className='fw-bold mb-0'>Shipping:</p>
                      <p className='mb-0'>
                        ₹{adminOrder?.paymentIntent?.shippingPrice?.toFixed(2)}
                      </p>
                    </div>
                    <div className='d-flex align-items-center justify-content-between border-top border-2 mt-2 py-2'>
                      ...
                      >
                        ₹
                        {(
                          adminOrder?.cartTotal +
                          adminOrder?.paymentIntent?.taxPrice +
                          adminOrder?.paymentIntent?.shippingPrice
                        ).toFixed(2)}
                      </p>
                    </div>
                    {adminOrder?.totalAfterDiscount > 1 && (
                      <div className='d-flex align-items-center justify-content-between border-top border-2 py-2'>
                        ...
                        <p className='mb-0'>
                          ₹{adminOrder?.paymentIntent?.amount}
                        </p>
                      </div>
                    )}
                  </div>
