...
import { outForDeliveryOrders } from '../../redux/actions/orderActions';
    ...
    data1.push({
      ...
      action: (
        <div className='d-flex align-items-center justify-content-center gap-2'>
          ...
          <Link
            to={`/admin/dashboard/update-status/outfordelivery/${adminOrders[i]?._id}`}
...
export default OutForDeliveredList;
